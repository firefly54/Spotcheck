...
def mainscreen():
    ...
    lamp_button = Button(mainscreen_labelframe, bg="dodger blue", activebackground="dodger blue", text="LAMP", fg='white', font=buttonFont, borderwidth=0, height=4, width=20, command=lamp_click)
    ...
    language_button = Button(mainscreen_labelframe, bg="dodger blue", activebackground="dodger blue", text="LANGUAGE", fg='white', font=buttonFont, borderwidth=0, height=4, width=20, command=language_click, state='disabled')
    ...
    help_button = Button(mainscreen_labelframe, bg="dodger blue", activebackground="dodger blue", text="HELP", fg='white', font=buttonFont, borderwidth=0, height=4, width=20, command=help_click, state='disabled')
